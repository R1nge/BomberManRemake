...
public class NetworkHashFinder : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        NetworkObject newOutput =
            EditorGUILayout.ObjectField("Object", output, typeof(NetworkObject), false) as NetworkObject;
    ...
    private NetworkObject FindByHash(uint hashID)
    {
        ...
        {
            Debug.LogError(
                "GlobalObjectIdHash field is null. Unity might have updated Netcode not to use this parameter anymore, in which case this tool is useless");
            return null;
        }
